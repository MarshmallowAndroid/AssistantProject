...
namespace Transcriber
{
    internal class InputDeviceBuffer
    {
        ...
        public InputDeviceBuffer(int ms, IWaveIn inputDevice)
        {
            lengthMs = ms;
            captureDevice = inputDevice;

            inputDevice.StartRecording();
            inputDevice.DataAvailable += CaptureDevice_DataAvailable;

            waveFormat = inputDevice.WaveFormat;
            sampleRate = inputDevice.WaveFormat.SampleRate;
